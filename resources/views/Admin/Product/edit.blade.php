            ...
            <div class="group-product-roperties">
                <div class="color col-md-3">
                    ...
                    <select name="color_id" id="" class="form-control">
                        ...
                        <option value="{{$color->id}}" @selected($product->colors->id == $color->id
                            )>{{$color->name}}</option>
                        @endforeach
                    </select>
                ...
                <div class="typeProduct col-md-3">
                    ...
                    <select name="type_product_id" id="" class="form-control">
                        ...
                        <option value="{{$typeproduct->id}}" @selected($product->typeProduct->id == $typeproduct->id
                ...
                <div class="gender col-md-3">
                    ...
                    <select name="gender_id" id="" class="form-control">
                        ...
                        <option value="{{$gender->id}}" @selected($product->gender->id == $gender->id
                            )>{{$gender->name}}</option>
                        @endforeach
                    </select>
                ...
                <div class="design col-md-3">
                    ...
                    <select name="design_id" id="" class="form-control">
                        ...
                        <option value="{{ $design->id }}" @selected($product->design->id == $design->id )>
                            {{$design->name}}
                        </option>
                        @endforeach
                    </select>
