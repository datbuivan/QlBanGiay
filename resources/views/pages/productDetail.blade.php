                    ...
                    <div class="p-t-33">
                        ...
                        <div class="flex-w flex-r-m p-b-10">
                            <div class="size-204 flex-w flex-m respon6-next">
                                ...
                                <button class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">Thêm
                                    vào giỏ hàng</button>
                    ...
                    <div class="tab-pane fade show active" id="description" role="tabpanel">
                        <div class="how-pos2 p-lr-15-md">
                            <p class="stext-102 cl6">
                                Giày thể thao Dope được coi là sự tự chăm sóc bản thân. Và với màu sắc lấy cảm hứng từ
                                các lối đi của cửa hàng bán đồ làm đẹp tại địa phương của bạn (cộng với lớp đệm Nike Air
                                giống như đám mây dưới chân), những chiếc J's cỡ trung này sẽ khiến bạn có cảm giác như
                                không có gì khác ngoài phần giữa. Hãy tiếp tục - hãy đối xử với chính mình.
                            </p>
                        </div>
                    </div>
