...
<html lang="en">
    <head>
        ...
        <link href="{{ asset('../../../QlBanGiay/public/Admin/vendor/fontawesome-free/css/all.min.css') }}" rel="stylesheet" type="text/css">
        <link
        ...
        <style>
            ...
            .group-product-roperties .color, .gender, .typeProduct, .design, .uploadImage{
                margin: 0;
                padding-left: 0px;
                padding-right: 12px;
            }
